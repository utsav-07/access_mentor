		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Access Mentor (GRC SOD)",
									"targetURL": "#comttlaccessmentor-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comttlaccessmentor-display": {
								"semanticObject": "comttlaccessmentor",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ttl.accessmentor",
									"url": sap.ui.require.toUrl("com/ttl/accessmentor")
								}
							}
						}
					}
